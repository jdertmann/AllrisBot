...
///
/// Most commonly, you will not need to implement this trait manually, as common types like `&str`, `String`, and `Display`
...
entity_fns! {
    ...
    ///
    /// Must be a top-level entity and contain no other entities.
    code: Code;
...
///
/// This is subject to Telegram restrictions (see [API docs](https://core.telegram.org/bots/api#formatting-options))
